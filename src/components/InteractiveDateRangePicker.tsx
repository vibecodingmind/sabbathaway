    ...
    <div className="p-4 bg-slate-50 dark:bg-slate-800/80 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-3">
      ...
      <div className="flex items-center justify-between pb-2 border-b border-slate-200 dark:border-slate-700">
        <div className="flex items-center gap-2">
          <CalendarIcon className="w-4 h-4 text-[#1B5E4A]" />
      ...
      <div className="grid grid-cols-7 gap-1">
        {calendarDays.map((d, idx) => {
          ...
          if (isSelectedStart || isSelectedEnd) {
            bgClass = 'bg-[#1B5E4A] text-white font-extrabold shadow-md scale-105 z-10';
          } else if (range) {
      ...
      <div className="pt-2 border-t border-slate-200 dark:border-slate-700 flex flex-wrap items-center justify-between text-xs">
        <div className="flex items-center gap-2">
          ...
          <span className="px-2 py-0.5 rounded-full bg-rose-100 dark:bg-rose-950 text-[#1B5E4A] font-extrabold text-[10px]">
            {nights} {nights === 1 ? 'Night' : 'Nights'}
          </span>
        </div>

        <div className="text-[10px] text-slate-500 flex items-center gap-1 font-medium">
          <Sparkles className="w-3 h-3 text-[#1B5E4A]" />
